ilk = linspace(-1.2247,1.2247,100);
son = linspace(-1.2247,1.2247,100);
x = [ilk; son];
...
for i = 1:100 %100 tane başlangıç koşulu oluşturulması için 100 kere döngüye girdi
    ...
    ssoru4(x0, 10); %bu başlangıç koşullarını grafikte çizdirme
end
...
title('V(x) < 2.25'); %figure başlık ekleme
