...
for i = 1:100 %100 tane başlangıç koşulu oluşturulması için 100 kere döngüye girdi
    ...
    ssoru4(x0, 2.6); %bu başlangıç koşullarını grafikte çizdirme
end
grid %figure grid ekleme
xlim([-3 3]); %soruda x eksenini (-3,3) arası istemiş
ylim([-8 8]); %soruda y eksenini (-8,8) arası istemiş
...
title('V(x) < 3'); %figure başlık ekleme
